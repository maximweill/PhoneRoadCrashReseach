...
def main():
    ...
    #     pipeline=ppl.definitions.OLD_PHONE_PIPELINE, #ppl.definitions.EXTRACT_CONTINUOUS_PIPELINE,
    ...
    #     pipeline=ppl.definitions.OLD_PHONE_PIPELINE, #ppl.definitions.PHONE_PIPELINE,
    ...
    #     log_path=Path("data_processing_gitignore/DEBUGGING_LOGS/start_continuous_stationary_parsing_log.csv")
    # )
    ...
    #     log_path=Path("data_processing_gitignore/DEBUGGING_LOGS/end_stationary_accel_framed_end_parsing_log.csv")
    # )

    ind_stationary_results = ppl.run_directory_parallel(
        pipeline=ppl.definitions.STATIONARY_IND_PARSING_PIPELINE,
